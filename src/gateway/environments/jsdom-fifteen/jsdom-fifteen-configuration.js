// @flow
import type {IJSDOMFifteenConfiguration} from "./types.js";

/**
 * Utility for creating a valid configuration to use with the JSDOM Sixteen
 * environment.
 */
export class JSDOMFifteenConfiguration implements IJSDOMFifteenConfiguration {
    +registrationCallbackName: string;
    +getFileList: $PropertyType<IJSDOMFifteenConfiguration, "getFileList">;
    +getResourceLoader: $PropertyType<
        IJSDOMFifteenConfiguration,
        "getResourceLoader",
    >;
    +afterEnvSetup: $PropertyType<IJSDOMFifteenConfiguration, "afterEnvSetup">;
