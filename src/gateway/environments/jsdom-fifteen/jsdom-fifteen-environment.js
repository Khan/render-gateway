 ...
 */
export class JSDOMFifteenEnvironment implements IRenderEnvironment {
    _configuration: IJSDOMFifteenConfiguration;
     ...
     */
    constructor(configuration: IJSDOMFifteenConfiguration) {
    ...
    _retrieveTargetFiles: (
        ...
        const traceSession = renderAPI.trace(
            "JSDOM15._retrieveTargetFiles",
            `JSDOMFifteenEnvironment retrieving files`,
        );
        try {
            /**
